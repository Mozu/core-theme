    ...
    function ($, _, Hypr, Backbone, api, CustomerModels, AddressModels, PaymentMethods, HyprLiveContext) {
        ...
        BillingInfo = CheckoutStep.extend({
            ...
            setPurchaseOrderInfo: function() {
                ...
                // Split payment is not deployed right now, this is where the logic will happen to enable it when it is ready.
            ...
            hasPaymentChanged: function(payment) {
                ...
                // For purchase orders it will void, then re-applys the payment even if nothing changes.
