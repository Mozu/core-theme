...
import { LeftNavigationHamburgerMenu } from './left.model';
...
export class NavigationLeftComponent implements OnInit, AfterViewInit, OnDestroy, OnChanges {
    ...
    public menuModel: LeftNavigationHamburgerMenu;
    subscriptions = [];
    ...
    ngOnInit() {
        ...
        this.menuModel = new LeftNavigationHamburgerMenu();
        this.leftNavigationHamburgerMenu();
    ...
    public appendDynamicLinks = (allFilteredLinks) => {        
        ...
        distinctDynamicLinks.forEach(element => {
            this.navigationService.fetchLeftNavigationHamburgerMenu().subscribe(successResponse => {                               
                this.menuModel.importExport = successResponse[3].label;
                element.modalWindowTitle = this.menuModel.importExport;
            })   
    ...
    public leftNavigationHamburgerMenu() {        
        this.navigationService.fetchLeftNavigationHamburgerMenu().subscribe(successResponse => {
            this._loggerService.info('NavigationLeftComponent : leftNavigationHamburgerMenu');            
            this.menuModel.mainLabel = successResponse[0].label;
            this.menuModel.systemLabel = successResponse[1].label;
            this.menuModel.homeLabel = successResponse[2].label;
        })        
    }  
}
