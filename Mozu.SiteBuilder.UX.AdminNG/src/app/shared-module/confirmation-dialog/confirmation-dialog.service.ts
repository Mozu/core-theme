...
export class ConfirmationDialogService {
    ...
    showConfirmationDialog: (dialogTitle: string, customMessage: string, primaryButtonText: string
        , isShowPrimaryButton: boolean, isShowSecondaryButton: boolean, secondaryButtonText: string) => void;

    constructor(private _logger: LoggerService,
        private _translate: TranslateService
    ) {
        this._logger.info('ConfirmationDialogService : constructor ');
    }

    public logError(error: any, isLogToConsole: boolean, isSendToServer: boolean): void {
        this._logger.info('ConfirmationDialogService : logError ');
