...
export class Constants {
    ...
    static webApis = {
        ...
        getLocationGroupConfig : environment.apiUrl + '/location/group/configuration/get',
        updateLocationGroupConfig : environment.apiUrl + '/location/group/configuration/edit',
