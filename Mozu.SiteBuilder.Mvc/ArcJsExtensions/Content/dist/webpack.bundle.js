...
const needle = __webpack_require__(12);
...
var fs          = __webpack_require__(5),
    ...
    debug       = __webpack_require__(15)('needle'),
    stringify   = __webpack_require__(23).build,
    multipart   = __webpack_require__(24),
    auth        = __webpack_require__(26),
    cookies     = __webpack_require__(28),
    parsers     = __webpack_require__(30),
    decoder     = __webpack_require__(32);

//////////////////////////////////////////
// variabilia

var version     = __webpack_require__(51).version;
...
var extend = Object.assign ? Object.assign : __webpack_require__(3)._extend;
...
try {
  ...
  var supportsColor = __webpack_require__(20);
...
var readFile = __webpack_require__(5).readFile,
    basename = __webpack_require__(25).basename;
...
var createHash = __webpack_require__(27).createHash;
...
var unescape = __webpack_require__(29).unescape;
...
;(function (sax) { // wrapper for non-node envs
  ...
  var Stream
  try {
    Stream = __webpack_require__(0).Stream
  } catch (ex) {
    Stream = function () {}
  }
  ...
  SAXStream.prototype.write = function (data) {
    if (typeof Buffer === 'function' &&
      ...
      if (!this._decoder) {
        var SD = __webpack_require__(8).StringDecoder
...
module.exports = function(charset) {
  try {
    if (!iconv) iconv = __webpack_require__(33);
  } catch(e) {
    /* iconv not found */
  }
...
module.exports = {
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(10).concat(__webpack_require__(48)) },
