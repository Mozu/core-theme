...
namespace Mozu.SiteBuilder.Mvc.Catalog
{
    ...
    public class RuntimeCategoryTreeProvider : ICategoryTreeProvider
    {
        ...
        private async Task<CategoryTree> GetAllCategoriesImpl() {
            var cacheKey = this.GetType().FullName +  _dataViewMode;
            ...
            try
            {
                ...
                var fetcher = new CatTreeFetcher() { Cachekey = cacheKey , Client = _productCategoryRuntimeWebApiClient.CloneWithoutUserClaims() };
