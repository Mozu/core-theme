...
{
    public class NavigationRepositoryThom : INavigationRepository
    {
        ...
        public NavigationRepositoryThom(IDocumentWebApiClient docWebApiClient, ICmsServiceWrapper cmsService, IStorefrontCache cache)
        {
