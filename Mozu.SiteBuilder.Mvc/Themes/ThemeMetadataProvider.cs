...
namespace Mozu.SiteBuilder.Mvc.Themes
{
    ...
    internal class ThemeMetadataProvider : IThemeMetaDataProvider
    {
        ...
        private ThemeConfiguration LoadThemeDescriptor(string themePath, string fileType )
        {
            ...
            themecfg.OrderTemplates = themecfgJson["orderTemplates"] == null ? new List<PageTypeDefinition>() : themecfgJson["orderTemplates"].ToObject<List<Mozu.SiteBuilder.Mvc.Models.CMS.PageTypeDefinition>>();
