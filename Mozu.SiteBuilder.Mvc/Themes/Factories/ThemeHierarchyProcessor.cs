...
namespace Mozu.SiteBuilder.Mvc.Themes.Factories
{
    ...
    class ThemeHierarchyProcessor
    {
        ...
        public void Process(Theme theme)
        {
            ...
            if (theme.Parent.MobileNotificationTemplates != null)
                theme.MobileNotificationTemplates = theme.MobileNotificationTemplates.Union(theme.Parent.MobileNotificationTemplates, new PageTemplateDefinitionEQ()).ToList();
