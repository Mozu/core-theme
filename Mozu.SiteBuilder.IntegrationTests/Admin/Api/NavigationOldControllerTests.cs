...
{
    [TestFixture]
    public class NavigationControllerOldTests
    {
        ...
        private NavigationRepositoryThom _navigationRepository;
        ...
        public void SetUp()
        {
            ...
            _navigationRepository = Substitute.For<NavigationRepositoryThom>();
        }
        ...
        private NavigationOldController GetApi()
        {
            return new NavigationOldController(_siteBuilderContext, _categoryWebApiClient, _cmsServiceWrapper, _productWebApiClient, _navigationRepository);
        }
    }
}