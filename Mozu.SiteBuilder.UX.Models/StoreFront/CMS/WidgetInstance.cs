    ...
    public class WidgetInstance : CmsDocumentBase
    {
      ...
      //  string _DefinitionId;
       ...
       // string _ZoneId; 
        ...
        public WidgetDefintion WigetDefinition { get; set; }
        ...
        public void Init ()
        {
            ...
            //WigetDefinition = WidgetDefintion.Mocks.FirstOrDefault(_wd => string.Equals((string)_doc.GetValue(CmsConstants.Widgets.widget_type_id), _wd.Id, StringComparison.OrdinalIgnoreCase)),
