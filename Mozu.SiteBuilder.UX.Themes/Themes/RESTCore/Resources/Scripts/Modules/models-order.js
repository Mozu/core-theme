define(
    ["jquery", "modules/knockout-plus", "pciaas", "modules/ko-component", "i18n!nls/messages-checkout", "i18n!nls/messages", "ajax!/addressschemes", "modules/actions-processor"],
    function ($, ko, PCIaaS, KOComponent, msg, genericMsg, AddressSchemes, processActions) {
        ...
        var defaultAddressConfig = {
            stateProvLabel: "State/Province"
        };

        var ShippingAddress = KOComponent.extend({
        ...
        function (conf) {
            ...
            this.addressConfig = ko.computed(function () {
                return $.extend({}, defaultAddressConfig, AddressSchemes && AddressSchemes[self.countryCode()]);
            });

        }),

        ShippingMethod = KOComponent.extend({
        ...
        PaymentSection = KOComponent.extend({
        ...
        OrderSummary = KOComponent.extend({
        ...
        CheckoutPage = KOComponent.extend({
