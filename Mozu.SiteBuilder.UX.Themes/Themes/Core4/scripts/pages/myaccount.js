require(['shim!modules/jquery-mozu[shim!vendor/jquery-colorbox[jquery=jQuery]>jQuery]>jQuery', 'modules/knockout-plus', 'modules/animatemodals', 'modules/models-myaccount'], function ($, ko, animateModals, MyAccountModels) {

    $(document).ready(function () {

        var $myAccountView = $('#mz-my-account'),
            customerData = $myAccountView.jsonData('customer'),
            userData = $myAccountView.jsonData('user'),
            ordersData = $myAccountView.jsonData('orders'),
