define(["jquery"],function ($) {
    ...
    $.fn.tagcloud = function (options) {
        var tagWeights, lowest, highest, range, fontIncr, colorIncr, weighting, opts = $.extend({}, $.fn.tagcloud.defaults, options);
    ...
    function tagColor(color, increment, weighting) {
        var ref, rgb = jQuery.map(toRGB(color.start), function (int, i) {
