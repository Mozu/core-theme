!(function() {
    ...
    this.handleImageClickActionChange = function (newValue) {
    ...
    this.handleImageSizeChange = function (newValue) {
    ...
    this.handleImageSourceChange = function (newValue) {
    ...
    this.handleLinkSourceChange = function (newValue) {
        var isFile = newValue === 'file',
    ...
    this.handleUploadFile = function (files) {
        this.down('#imageField').onUploadFile(files)
    };

    this.toggleAssociator = function (state, button, store) {
        if (state) {
            if (!this.associator) {
    ...
    this.widget.mon(this.imageStore, {
        datachanged1: {
            scope: this,
            fn: function(store) {
    ...
    this.widget.mon(this.linkStore, {
        datachanged1: {
            scope: this,
            fn: function(store) {
                var record = store.first(),
