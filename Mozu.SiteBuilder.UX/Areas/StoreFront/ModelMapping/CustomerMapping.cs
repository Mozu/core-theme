...
using CustomerAccountGroup = Mozu.Customer.Contracts.CustomerAccountGroup;
using CustomerAccountContact = Mozu.Customer.Contracts.CustomerAccountContact;
using CustomerAccountNote = Mozu.Customer.Contracts.CustomerAccountNote;
