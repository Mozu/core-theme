...
namespace Mozu.SiteBuilder.UX.Constants
{
    public static class MimeTypes
    {
        public static readonly Lazy<IReadOnlyDictionary<string, string>> MimeTypesByExtension = new Lazy<IReadOnlyDictionary<string, string>>(BuildMimeTypeDictionary, true);
        ...
        static IReadOnlyDictionary<string, string> BuildMimeTypeDictionary()
        {
