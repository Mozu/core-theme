(function() {
    ...
    (function(define, exportFn) {
        exportFn(function() {
            ...
            var HyperLive = new amds[0].Environment(new HyperLiveLoader(), {
                dev: true
            });
        });
    })(internalDefine, typeof define === "function" && define.amd ? define : function(fn) {
        typeof exports === "object" && typeof module === "object" ? module.exports = fn() : this.HyperLive = fn();
    });
})();