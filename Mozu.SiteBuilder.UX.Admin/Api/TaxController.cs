...
namespace Mozu.SiteBuilder.UX.Admin.Api
{
    ...
    public class TaxController : BaseController
    {
        ...
        public Response<List<TaxRate>> Create(List<TaxRate> vms)
        {
        ...
        public Response<List<TaxRate>> Edit(List<TaxRate> vms)
        {
        ...
        public Response<TaxRate> Delete(List<TaxRate> vms)
        {
        ...
        public Response<List<TaxRate>> GetTaxRates(PagingParamaters pagingParams, FilterCollection extFilter)
        {
