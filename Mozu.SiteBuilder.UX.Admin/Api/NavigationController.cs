...
namespace Mozu.SiteBuilder.UX.Admin.Api
{
    ...
    public class NavigationController : BaseController
    {
        ...
        private ISiteBuilderContext _sbCtx;
        ...
        ///  Public constructor.
        /// </summary>
        public NavigationController(ISiteBuilderContext sbCtx, INavigationRepositoryAsync navRepo, ICategoryWebApiClient catClient, ICmsServiceWrapper cmsService)
        {
            _sbCtx = sbCtx;
            _navRepo = navRepo;
        ...
        [WebGet(UriTemplate = "list2")]
        public Response<List<NavigationTreeNode>> MockList()
        {
            return List2(new List<NavigationTreeNode> {
                ...
                new NavigationTreeNode {
                    Id = "page^^pages^^2fbc5402-5a14-28e8-901e-737900007530",
                    Name = "test1",
                    ParentId = "category^^54",
                    Index = 1,
                    NodeType = NODE_TYPE_PAGE,
                    Url = "/pages/test1"
                },
            });
        }
        ...
        public async Task<Response<List<NavigationTreeNode>>> List()
        {
            ...
            var pageTask = _cmsService.GetList(new CmsListRequest() { Collection = "pages", PageSize = 100 });
            ...
            await Task.WhenAll(catTask, pageTask, blogTask, navTask);
            ...
            var sortedCats =
                ...
                let node = Mapper.Map<NavigationTreeNode>(c)
                let _ = node.ParentId = c.ParentCategoryId.HasValue ? "category^^" + c.ParentCategoryId : ROOT_NODE_NAME
            ...
            return List2(masterList.OrderBy(n => n.ParentId).ThenBy(n => n.Index).ToList());
        }
