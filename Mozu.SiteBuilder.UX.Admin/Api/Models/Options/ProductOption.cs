...
namespace Mozu.SiteBuilder.UX.Admin.Api.Models.Options
{
    ...
    public class ProductOptionValue : OptionValue 
    {
        ...
        public string intention2 { get; set; }
         ...
         [IgnoreDataMember()]
         public OptionIntentions? intention
         {
             get
             {
                 OptionIntentions ret ;
                 if (Enum.TryParse<OptionIntentions>(this.intention2, out ret))
                 {
                     return ret;
                 }
                 return OptionIntentions.standAlone;
             }
         }
       

    }
    public enum OptionIntentions
    {
        configuration,
        standAlone,
        spec
