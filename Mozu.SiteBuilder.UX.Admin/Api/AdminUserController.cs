...
//{
//    [AllowAnonymous]
//    [WebApi("app/adminUser", SuppressDescriptorGeneration = true)]
...
//        public AdminUserController(IMultiScopeAdminUserWebApiClient user, IMultiScopeRoleWebApiClient role, IAuthTicketWebApiClient auth, ITenantsWebApiClient tenantsClient, IAuthenticationHelper authHelper, IUniversalSiteApiClient siteClient, IInvitationWebApiClient invitationWebApiClient, IMultiScopeAdminUserWebApiClient adminUserWebApiClient, ISettings settings, IUserHelper userHelper, IApiContext apiContext)
//        {
//            _usersRepo = user;
//            _rolesRepo = role;
...
//        public async Task<HttpResponseMessage > GetUsers([FromUri]PagingParamaters pagingParams, FilterCollection extFilter)
//        {
//            List<Core.Api.Contracts.User> ret = new List<Core.Api.Contracts.User>();
...
//                {
//                    ret.Add(task.Result.ReadAsSync());
//                }
//            }
//            return Request.CreateResponse(HttpStatusCode.OK, List2(ret), LowerCaseJsonMediaTypeFormatter.Default);
