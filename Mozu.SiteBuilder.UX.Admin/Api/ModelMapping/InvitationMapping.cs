...
namespace Mozu.SiteBuilder.UX.Admin.Api.ModelMapping
{
    public static class InvitationMapping
    {
        ...
        internal static void Configure(UserMapping userMapping)
        {
            userMapping.CreateMap<Invitation, AdminUser.Contracts.Invitation>()
            ...
            userMapping.CreateMap<AdminUser.Contracts.Invitation, Invitation>()
