    ...
    public class DiscountMapping : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            Mapper.CreateMap<DC.Discount, Discount>()
                ...
                .ForMember(x => x.IncludedPaymentType, opt => opt.ResolveUsing(x => (x.Conditions != null && !x.Conditions.IncludedPaymentWorkflows.IsNullOrEmpty())
                ...
                .ForMember(x => x.MaximumQuantityPerRedemption, opt => opt.ResolveUsing(x => (x.Target != null)
                    ? x.Target.MaximumQuantityPerRedemption
                    : null))
                ...
                .ForMember(x => x.ShippingZones,
                    opt => opt.ResolveUsing(x => (x.Target != null && x.Target.ShippingZones != null)
                ...
                .ForMember(x => x.MinimumOrderAmount, opt => opt.ResolveUsing(x => (x.Conditions != null)
                    ? x.Conditions.MinimumOrderAmount
                    : null))
                ...
                .ForMember(x => x.MinimumQuantityProductsRequiredInCategories,
                    opt => opt.ResolveUsing(x => (x.Conditions != null)
                        ? x.Conditions.MinimumQuantityProductsRequiredInCategories
                        : null))
                .ForMember(x => x.MinimumQuantityRequiredProducts, opt => opt.ResolveUsing(x => (x.Conditions != null)
                    ? x.Conditions.MinimumQuantityRequiredProducts
                    : null))
                .ForMember(x => x.MinimumCategorySubtotalBeforeDiscounts,
                    opt => opt.ResolveUsing(x => (x.Conditions != null)
                        ? x.Conditions.MinimumCategorySubtotalBeforeDiscounts
                        : null))
