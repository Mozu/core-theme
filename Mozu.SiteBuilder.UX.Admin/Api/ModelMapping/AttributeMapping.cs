    ...
    public class AttributeMapping : Profile
    {
        ...
        public AttributeMapping()
        {
            ...
            CreateMap<AttributeValue, DC.AttributeVocabularyValue>()
                ...
                .ForMember(x => x.MappedGenericValues, op => op.ResolveUsing(x => x.MappedGenericValues));
            ...
            CreateMap<DC.AttributeVocabularyValue, AttributeValue>()
                ...
                .ForMember(x => x.MappedGenericValues, op => op.ResolveUsing(dc => dc.MappedGenericValues))
            ...
            CreateMap<DC.Attribute, Attribute>()
                ...
                .ForMember(x => x.IsValueMappingAttribute, opt => opt.ResolveUsing(dc => dc.IsValueMappingAttribute ?? false))

                //SearchDisplayValue really means search label
                ...
                .ForMember(x => x.ValueMappingAttributeFQN, op => op.ResolveUsing(dc => dc.ValueMappingAttributeFQN))
                .ForMember(x => x.IsValueMappingAttribute, op => op.ResolveUsing(dc => dc.IsValueMappingAttribute ?? false))
