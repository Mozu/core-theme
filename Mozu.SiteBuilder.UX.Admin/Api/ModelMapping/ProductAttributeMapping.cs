...
using AttributeMetadataItem = Mozu.SiteBuilder.UX.Admin.Api.Models.Attributes.Product.AttributeMetadataItem;
using AttributeModel = Mozu.SiteBuilder.UX.Admin.Api.Models.Attributes.Product.Attribute;
using AttributeVocabularyValue = Mozu.SiteBuilder.UX.Admin.Api.Models.Attributes.Product.AttributeVocabularyValue;
using AttributeVocabularyValueLocalizedContent = Mozu.SiteBuilder.UX.Admin.Api.Models.Attributes.Product.AttributeVocabularyValueLocalizedContent;
