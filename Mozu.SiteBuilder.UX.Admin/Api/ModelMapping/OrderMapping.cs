...
//                             Quantity = remainingQuantity
        ...
        private void Map_DcPayment_to_OrderPayment()
        {
            Mapper.CreateMap<PaymentsDC.Payment, OrderPayment>()
                ...
                .ForMember(x=>x.PurchaseOrderInfo, op=>op.ResolveUsing(dc => dc.BillingInfo != null && dc.BillingInfo.Card != null
                    && dc.PaymentType == PaymentsDC.PaymentTypeConst.PURCHASE_ORDER?dc.BillingInfo.PurchaseOrderPayment:null))
