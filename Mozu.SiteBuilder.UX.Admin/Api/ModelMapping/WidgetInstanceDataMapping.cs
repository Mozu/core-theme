...
//{
//    public class WidgetInstanceDataMapping : Profile
//    {
...
//        {
//            // To model
//            Mapper.CreateMap<Mozu.Content.Contracts.Document , WidgetInstanceData>()
...
//            // To data contract
//            Mapper.CreateMap<WidgetInstanceData, Mozu.Content.Contracts.Document>()
//                .ForMember(x => x.Amount, op => op.MapFrom(x => x.Amount))
//                .ForMember(x => x.AmountType, op => op.MapFrom(x => x.AmountType))
