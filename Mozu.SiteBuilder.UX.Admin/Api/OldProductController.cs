...
namespace Mozu.SiteBuilder.UX.Admin.Api
{
    ...
    public class OldProductController : BaseController
    {
        ...
        public OldProductController(IProductWebApiClient productClient)
        {
        ...
        public Task<Response<List<OldProduct>>> CreateProduct(List<OldProduct> products)
        {
            var retList = (from viewModel in products
                           ...
                           select Mapper.Map<OldProduct>(ret)).ToList();
        ...
        public Task<Response<List<OldProduct>>> EditProduct(List<OldProduct> products, int? id = null)
        {
        ...
        public Task<Response<OldProduct>> DeleteProduct(List<OldProduct> products)
        {
            ...
            return SuccessWithTotal<OldProduct>(products.Count);
        }
        ...
        public Task<Response<OldProduct>> DuplicateProduct(string id)
        {
         ...
         //   origProd.Id = null;
            ...
            return Single(Mapper.Map<OldProduct>(newProd));
        }

        [WebGet(UriTemplate = "list")]
        public Task<Response<List<OldProduct>>> GetProductList([FromUri]PagingParamaters pagingParams, [FromUri]FilterCollection extFilter)
        {
            ...
            return List(Mapper.Map<List<OldProduct>>(res.Items), (int) res.TotalCount);
        }
        class PropertyGuy
        {
