...
namespace Mozu.CARS.Contracts.Api
{
    ...
    /// </summary>
    public interface IFedexCrossBorderControllerApi
    {
        /// <summary>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class FedexCrossBorderControllerApi : IFedexCrossBorderControllerApi
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FedexCrossBorderControllerApi"/> class.
        /// </summary>
        /// <param name="apiClient"> an instance of ApiClient (optional)</param>
        /// <returns></returns>
        public FedexCrossBorderControllerApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public FedexCrossBorderControllerApi(String basePath)
        {
        ...
        public CallableCancelLabelResponse CancelPackNotificationUsingPOST (CancelPackNotificationRequest body)
        {
            ...
            var path = "/api/v1/fedexCrossBorder/cancelPackNotification";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling CancelPackNotificationUsingPOST: " + response.Content, response.Content);
        ...
        public CallablePackNotificationResponse CreatePackNotificationUsingPOST (PackNotificationRequest body)
        {
            ...
            var path = "/api/v1/fedexCrossBorder/createPackNotification";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling CreatePackNotificationUsingPOST: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
        ...
        public CallableGetDocumentsResponse GetDocumentsUsingPOST (GetDocumentsRequest body)
        {
            ...
            var path = "/api/v1/fedexCrossBorder/getDocuments";
            path = path.Replace("{format}", "json");
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetDocumentsUsingPOST: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
