...
namespace Mozu.Inventory.Contracts.Model
{
    ...
    /// </summary>
    [DataContract]
  public class FetchFileConfigRequest : BaseRequest {
    /// <summary>
    ...
    /// </summary>
    /// <value>Flag for if its a test ftp config</value>
    [DataMember(Name="testFTPConfigs", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "testFTPConfigs")]
    public bool? TestFTPConfigs { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  TestFTPConfigs: ").Append(TestFTPConfigs).Append("\n");
