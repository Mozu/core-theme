...
namespace Swagger.Fulfiller.Api
{
    ...
    public interface IShipmentControllerApi
    {
        ...
        ResponseEntity CancelShipmentUsingPUT (CancelShipment body, int? xVolTenant, int? shipmentNumber, int? xVolSite);
        /// <summary>
        /// canceledItems 
        /// </summary>
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResponseEntity</returns>
        ResponseEntity CanceledItemsUsingPOST (List<CanceledItem> body, int? xVolTenant, int? shipmentNumber, int? xVolSite);
        /// <summary>
        /// deleteShipment 
        /// </summary>
        /// <param name="shipmentNumber">shipmentNumber</param>
        ...
        Object DeleteShipmentUsingDELETE (int? shipmentNumber, int? xVolTenant, int? xVolSite);
        /// <summary>
        /// execute 
        /// </summary>
        ...
        /// <param name="xVolSite"></param>
        /// <returns>Object</returns>
        Object ExecuteUsingPUT (Dictionary<string, Object> body, int? xVolTenant, int? shipmentNumber, string taskId, int? xVolSite);
        /// <summary>
        /// fulfillShipment 
        /// </summary>
        /// <param name="shipmentNumber">shipmentNumber</param>
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResponseEntity</returns>
        ResponseEntity FulfillShipmentUsingPUT (int? shipmentNumber, int? xVolTenant, int? xVolSite);
        /// <summary>
        /// getShipment 
        /// </summary>
        /// <param name="shipmentNumber">shipmentNumber</param>
        ...
        ResourceShipment GetShipmentUsingGET (int? shipmentNumber, int? xVolTenant, string fields, int? xVolSite);
        /// <summary>
        /// getShipments 
        /// </summary>
        /// <param name="xVolTenant"></param>
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResourcesResourceShipment</returns>
        ResourcesResourceShipment GetShipmentsUsingGET (int? xVolTenant, string fields, string filter, bool? isLate, string locationCode, int? page, string quickSearch, int? size, string sort, int? xVolSite);
        /// <summary>
        /// getTasks 
        /// </summary>
        /// <param name="shipmentNumber">shipmentNumber</param>
        /// <param name="xVolTenant"></param>
        /// <param name="xVolSite"></param>
        /// <returns>ResourcesTask</returns>
        ResourcesTask GetTasksUsingGET (int? shipmentNumber, int? xVolTenant, int? xVolSite);
        /// <summary>
        /// newShipment 
        /// </summary>
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResourceShipment</returns>
        ResourceShipment NewShipmentUsingPOST1 (Shipment body, int? xVolTenant, int? xVolSite);
        /// <summary>
        /// rejectShipment 
        /// </summary>
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResourceShipment</returns>
        ResourceShipment ReplaceShipmentUsingPUT (Shipment body, int? xVolTenant, int? shipmentNumber, int? xVolSite);
        /// <summary>
        /// skipTask 
        /// </summary>
        /// <param name="shipmentNumber">shipmentNumber</param>
        ...
        /// <param name="xVolSite"></param>
        /// <returns>Object</returns>
        Object SkipTaskUsingPUT (int? shipmentNumber, string taskId, int? xVolTenant, int? xVolSite);
        /// <summary>
    ...
    public class ShipmentControllerApi : IShipmentControllerApi
    {
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResponseEntity</returns>
        public ResponseEntity CancelShipmentUsingPUT (CancelShipment body, int? xVolTenant, int? shipmentNumber, int? xVolSite)
        {
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResponseEntity</returns>
        public ResponseEntity CanceledItemsUsingPOST (List<CanceledItem> body, int? xVolTenant, int? shipmentNumber, int? xVolSite)
        {
            // verify the required parameter 'body' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>Object</returns>
        public Object DeleteShipmentUsingDELETE (int? shipmentNumber, int? xVolTenant, int? xVolSite)
        {
            // verify the required parameter 'shipmentNumber' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>Object</returns>
        public Object ExecuteUsingPUT (Dictionary<string, Object> body, int? xVolTenant, int? shipmentNumber, string taskId, int? xVolSite)
        {
            // verify the required parameter 'body' is set
...
path = path.Replace("{" + "taskId" + "}", ApiClient.ParameterToString(taskId));
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResponseEntity</returns>
        public ResponseEntity FulfillShipmentUsingPUT (int? shipmentNumber, int? xVolTenant, int? xVolSite)
        {
            // verify the required parameter 'shipmentNumber' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResourceShipment</returns>
        public ResourceShipment GetShipmentUsingGET (int? shipmentNumber, int? xVolTenant, string fields, int? xVolSite)
        {
            // verify the required parameter 'shipmentNumber' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResourcesResourceShipment</returns>
        public ResourcesResourceShipment GetShipmentsUsingGET (int? xVolTenant, string fields, string filter, bool? isLate, string locationCode, int? page, string quickSearch, int? size, string sort, int? xVolSite)
        {
            // verify the required parameter 'xVolTenant' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
            ...
            return (ResourcesResourceShipment) ApiClient.Deserialize(response.Content, typeof(ResourcesResourceShipment), response.Headers);
        }
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResourcesTask</returns>
        public ResourcesTask GetTasksUsingGET (int? shipmentNumber, int? xVolTenant, int? xVolSite)
        {
            // verify the required parameter 'shipmentNumber' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
            ...
            return (ResourcesTask) ApiClient.Deserialize(response.Content, typeof(ResourcesTask), response.Headers);
        }
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResourceShipment</returns>
        public ResourceShipment NewShipmentUsingPOST (Shipment body, int? xVolTenant, int? xVolSite)
        {
            // verify the required parameter 'body' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResourceShipment</returns>
        public ResourceShipment NewShipmentUsingPOST1 (Shipment body, int? xVolTenant, int? xVolSite)
        {
            // verify the required parameter 'body' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResponseEntity</returns>
        public ResponseEntity RejectShipmentUsingPUT (RejectShipment body, int? xVolTenant, int? shipmentNumber, int? xVolSite)
        {
            // verify the required parameter 'body' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>ResourceShipment</returns>
        public ResourceShipment ReplaceShipmentUsingPUT (Shipment body, int? xVolTenant, int? shipmentNumber, int? xVolSite)
        {
            // verify the required parameter 'body' is set
 ...
 if (xVolTenant != null) headerParams.Add("x-vol-tenant", ApiClient.ParameterToString(xVolTenant)); // header parameter
        ...
        /// <param name="xVolSite"></param>
        /// <returns>Object</returns>
        public Object SkipTaskUsingPUT (int? shipmentNumber, string taskId, int? xVolTenant, int? xVolSite)
        {
            // verify the required parameter 'shipmentNumber' is set
