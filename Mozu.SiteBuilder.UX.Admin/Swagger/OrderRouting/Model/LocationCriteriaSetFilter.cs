...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class LocationCriteriaSetFilter {
    /// <summary>
    /// Gets or Sets AcceptNulls
    /// </summary>
    [DataMember(Name="acceptNulls", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "acceptNulls")]
    public bool? AcceptNulls { get; set; }
    ...
    public List<LocationCriteriaSetDataDefinition> Definitions { get; set; }
    ...
    /// <summary>
    /// Gets or Sets LocationCriteriaSet
    /// </summary>
    [DataMember(Name="locationCriteriaSet", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "locationCriteriaSet")]
    public LocationCriteriaSet LocationCriteriaSet { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  AcceptNulls: ").Append(AcceptNulls).Append("\n");
      ...
      sb.Append("  LocationCriteriaSet: ").Append(LocationCriteriaSet).Append("\n");
