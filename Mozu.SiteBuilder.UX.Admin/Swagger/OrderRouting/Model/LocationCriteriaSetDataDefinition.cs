...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class LocationCriteriaSetDataDefinition {
    /// <summary>
    ...
    /// <summary>
    /// Gets or Sets DataDefinitionID
    /// </summary>
    [DataMember(Name="dataDefinitionID", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "dataDefinitionID")]
    public int? DataDefinitionID { get; set; }

    /// <summary>
    /// Gets or Sets DataUnitString
    /// </summary>
    [DataMember(Name="dataUnitString", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "dataUnitString")]
    public string DataUnitString { get; set; }
    ...
    /// </summary>
    [DataMember(Name="filterable", EmitDefaultValue=false)]
    ...
    public override string ToString()  {
      ...
      sb.Append("  DataDefinitionID: ").Append(DataDefinitionID).Append("\n");
      sb.Append("  DataUnitString: ").Append(DataUnitString).Append("\n");
