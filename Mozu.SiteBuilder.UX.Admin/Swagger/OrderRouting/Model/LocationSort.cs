...
namespace IO.Swagger.Model {
  ...
  public class LocationSort {
    ...
    /// <summary>
    /// Gets or Sets LocationSortID
    /// </summary>
    [DataMember(Name="locationSortID", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "locationSortID")]
    public int? LocationSortID { get; set; }
    ...
    /// </summary>
    [DataMember(Name="sortingType", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "sortingType")]
    ...
    public override string ToString()  {
      ...
      sb.Append("  LocationSortID: ").Append(LocationSortID).Append("\n");
