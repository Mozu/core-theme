...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class LocationCriteriaSet {
    /// <summary>
    /// Gets or Sets ColumnDefinitions
    /// </summary>
    [DataMember(Name="columnDefinitions", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "columnDefinitions")]
    public List<LocationCriteriaSetDataDefinition> ColumnDefinitions { get; set; }
    ...
    /// <summary>
    /// Gets or Sets LocationCriteriaSetID
    /// </summary>
    [DataMember(Name="locationCriteriaSetID", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "locationCriteriaSetID")]
    public int? LocationCriteriaSetID { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  LocationCriteriaSetID: ").Append(LocationCriteriaSetID).Append("\n");
