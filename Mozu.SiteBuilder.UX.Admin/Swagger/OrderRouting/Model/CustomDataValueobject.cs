...
namespace IO.Swagger.Model {
  ...
  /// </summary>
  [DataContract]
  public class CustomDataValueobject {
    /// <summary>
    ...
    /// <summary>
    /// Gets or Sets CustomDataValueID
    /// </summary>
    [DataMember(Name="customDataValueID", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "customDataValueID")]
    public int? CustomDataValueID { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class CustomDataValueobject {\n");
      sb.Append("  Created: ").Append(Created).Append("\n");
      sb.Append("  CreatorUsername: ").Append(CreatorUsername).Append("\n");
      sb.Append("  CustomDataValueID: ").Append(CustomDataValueID).Append("\n");
