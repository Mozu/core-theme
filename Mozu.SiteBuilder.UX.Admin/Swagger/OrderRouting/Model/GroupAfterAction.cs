...
namespace IO.Swagger.Model {
  ...
  public class GroupAfterAction {
    ...
    /// </summary>
    [DataMember(Name="failoverAction", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "failoverAction")]
    ...
    /// </summary>
    [DataMember(Name="restartAttempt", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "restartAttempt")]
    public string RestartAttempt { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("  FailoverAction: ").Append(FailoverAction).Append("\n");
      sb.Append("  Name: ").Append(Name).Append("\n");
      sb.Append("  PathString: ").Append(PathString).Append("\n");
      sb.Append("  Persisted: ").Append(Persisted).Append("\n");
      sb.Append("  RestartAttempt: ").Append(RestartAttempt).Append("\n");
