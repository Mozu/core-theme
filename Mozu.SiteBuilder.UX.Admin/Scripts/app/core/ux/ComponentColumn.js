/** 
 * @class Taco.core.ux.ComponentColumn
 * 
 *
 * ??ORPHAN??
 * 
 ...
 */
Ext.define('Taco.core.ux.ComponentColumn', {
    alias: 'widget.componentcolumn',
    extend: 'Ext.grid.column.Column',
    requires: ['Taco.core.CTemplate'],
    ...
    */
    ...
    createTemplate: function (tpl) {
        return tpl && tpl.isTemplate
            ? tpl
            : Ext.create('Taco.core.CTemplate', tpl || ['{', this.dataIndex, '}']);
    },
