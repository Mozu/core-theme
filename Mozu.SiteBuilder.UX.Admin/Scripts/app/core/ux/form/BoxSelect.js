/**
 * @class Taco.core.ux.form.BoxSelect
...
Ext.define('Taco.core.ux.form.BoxSelect', {
    ...
    */
    ...
    /**
    * @cfg {String} shortField An alternate string to use for selected items (in place of displayField).
    * The typeAhead will still operate on the full displayField.
    * (defaults to empty string, but assumes displayField's value if left empty)
    */
    shortField: '',
    ...
    */
    initComponent: function () {
        ...
        if (Ext.isEmpty(me.shortField)) {
            me.shortField = me.displayField;
        }
    },
    ...
    */
    onLoad: function () {
        ...
        if (valueStore) {
            if (!Ext.isEmpty(val) && (valueStore.getCount() === 0)) {
                if (Ext.isArray(val)) {
                    val = Ext.Array.clone(val);
                }
                me.setValue(val, false, true);
            }
        ...
        if (me.multiSelect && (me.delimiterEndingRegexp && me.delimiterEndingRegexp.test(rawValue)) ||
            ...
            if (!Ext.isEmpty(rawValue)) {
                ...
                if (rec) {
                    ...
                    me.inputEl.dom.value = '';
                    me.inputEl.focus();
                    me.fireEvent('valueschanged', rec);
                }
            }
        }
    ...
    */
    getMultiSelectItemMarkup: function () {
        ...
        if (!me.multiSelectItemTpl) {
            ...
            ' selected',
            '</tpl>',
            '" data-qtip="{[typeof values === "string" ? values : values.' + me.displayField + ']}">',
    ...
    */
    setValue: function (value, doSelect, skipLoad) {
        ...
        if ((skipLoad !== true) && (unknownValues.length > 0) && (me.queryMode === 'remote')) {
            ...
            //phipps
            //hack:adding this to support track dirty state.   hopefully it doesnt break anything else?
            this.value = Ext.Array.clone(value);
            return false;
        }
