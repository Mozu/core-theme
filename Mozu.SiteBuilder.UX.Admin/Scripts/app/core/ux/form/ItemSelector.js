/**
 * @class Taco.core.ux.form.ItemSelector
 *
 ...
 */
Ext.define('Taco.core.ux.form.ItemSelector', {
    extend: 'Taco.core.ux.form.MultiSelect',
    alias: ['widget.itemselectorfield', 'widget.itemselector'],
    alternateClassName: ['Taco.core.ux.ItemSelector'],
    requires: [
        'Ext.button.Button',
        'Taco.core.ux.form.MultiSelect'
    ],
    ...
    createList: function(){
        ...
        return Ext.create('Taco.core.ux.form.MultiSelect', {
            submitValue: false,
            flex: 1,
