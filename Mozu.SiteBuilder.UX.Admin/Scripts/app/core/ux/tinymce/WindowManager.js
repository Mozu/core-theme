/**
 * @class Taco.core.ux.tinymce.WindowManager
 */
Ext.define("Taco.core.ux.tinymce.WindowManager", {

    createInstance: function () {
        return this.tmceWindowMgr.createInstance.apply(this.tmceWindowMgr, arguments);
    },

    constructor: function (config) {
        this.tmceWindowMgr = new tinymce.WindowManager(config.editor);
        Ext.applyIf(this, this.tmceWindowMgr);
    },
