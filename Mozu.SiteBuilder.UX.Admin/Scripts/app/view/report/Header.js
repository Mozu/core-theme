...
Ext.define('Taco.view.report.Header', {
    ...
    tpl: [
        ...
        '<div class="taco-order-detail-header-section customer-data">',
            ...
            '<h2><a href="\#customers/edit/{customerId}\">{billingContact.firstName:stripTags} {billingContact.lastName:stripTags}</a></h2>',
            '<div class="company">{billingContact.companyName:stripTags}</div>',
        '<tpl if="billingContact.address1">',
            '<div class="address">{billingContact.address1:stripTags} {billingContact.cityOrTown:stripTags}, {billingContact.stateOrProvince:stripTags} {billingContact.postalOrZipCode:stripTags} {billingContact.countryCode}</div>',
        '</tpl>',
        '</div>',
