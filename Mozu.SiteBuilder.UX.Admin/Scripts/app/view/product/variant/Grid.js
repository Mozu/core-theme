...
//        searchable: 'Taco.core.ux.mixins.Searchable',
    ...
    initComponent: function () {
        ...
        Ext.Array.each(unsavedModifications, function (record) {
            me.modifiedRecords.add(record.interalId, record.data);
        });
...
//        this.plugins.push(this.rowEditor);
    ...
    doSave: function () {
        ...
        this.mon(this.product.productVariationStore, 'load', function (store) {
        ...
        this.product.productVariationStore.load();
