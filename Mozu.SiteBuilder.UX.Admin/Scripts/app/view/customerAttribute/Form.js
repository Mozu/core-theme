Ext.define('Taco.view.customerAttribute.Form', {
    extend: 'Taco.view.product.subform.Subform',
    requires: ['Taco.view.option.valueEditor.MultiValue'],
    createTitle: 'Create New Customer Attribute',
    ...
    buildFormComponents: function () {
        ...
        this.items = [{
            ...
            name: 'code',
            allowBlank: false,
            emptyText: 'Enter an attribute code',
            width: 300,
            enableKeyEvents: true/*,
            listeners:{
            ...
            readOnly: this.isEdit(),
            store: [
                ['storefront,Admin', 'Storefront & Admin'],
                ['admin', 'Admin Only']
            ],
            listeners: {
