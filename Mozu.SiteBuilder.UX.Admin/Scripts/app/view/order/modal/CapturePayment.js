            ...
            items: [
                {
                    ...
                    selectOnFocus: true,
                    width: 170,
                    value: this.record.get('paymentType') === 'PurchaseOrder' ? this.record.get('amountAuthorized') : Math.min(this.record.data.amountAuthorized, this.order.getCaptureAmountHint())
                },
                notes
            ]
        });
