            ...
            items: [
                {
                    ...
                    selectOnFocus: true,
                    width: 170,
                    value: this.record.get('paymentType') === 'PurchaseOrder' ? Math.min(this.order.getCaptureAmountHint(), this.record.get('amountRequested')) : Math.min(this.record.data.amountAuthorized, this.order.getCaptureAmountHint())
                },
                notes
            ]
        });
