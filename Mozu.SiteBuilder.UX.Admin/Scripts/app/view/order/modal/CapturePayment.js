            ...
            items: [
                {
                    ...
                    selectOnFocus: true,
                    width: 170,
                    value: this.record.get('paymentType') === 'PurchaseOrder' ? (this.record.get('amountRequested') - this.record.get('amountCollected')) : Math.min(this.record.data.amountAuthorized, this.order.getCaptureAmountHint())
                },
                notes
            ]
        });
