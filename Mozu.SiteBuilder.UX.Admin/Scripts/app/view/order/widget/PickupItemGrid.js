                ...
                '<table style="border-collapse: collapse; border-spacing: 0px; width: 100%;"><tbody>',
                    ...
                    '<tr>',
                        '<td style="border-top: 2px solid black; padding: 4px 30px 20px 4px;">',
                            '<div>{billingContact.firstName:stripTags} {billingContact.lastName:stripTags}</div>',
                            '<div>{billingContact.address1:stripTags}</div>',
                            '<div>{billingContact.cityOrTown:stripTags}, {billingContact.stateOrProvince:stripTags} {billingContact.postalOrZipCode:stripTags}</div>',
                            '<div>{billingContact.countryCode}</div>',
                            '<div>{billingContact.homePhone:stripTags}</div>',
                            '<div>{billingContact.email:stripTags}</div>',
                        '</td>',
                        '<td style="border-top: 2px solid black; font-size: 16px; font-weight: bold; padding: 4px 30px 20px 4px;">',
                            '<div>{fulfillmentContact.firstName:stripTags} {fulfillmentContact.lastName:stripTags}</div>',
                            '<div>{fulfillmentContact.address1:stripTags}</div>',
                            '<div>{fulfillmentContact.cityOrTown:stripTags}, {fulfillmentContact.stateOrProvince:stripTags} {fulfillmentContact.postalOrZipCode:stripTags}</div>',
                            '<div>{fulfillmentContact.countryCode}</div>',
                            '<div>{fulfillmentContact.homePhone:stripTags}</div>',
                            '<div>{fulfillmentContact.email:stripTags}</div>',
                        '</td>',
                    '</tr>',
                    '<tr>',
