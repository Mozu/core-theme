        ...
        return [
            '<tpl for="discounts">',
                ...
                '" tabindex="-1">',
                    ...
                    '</td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '">',
                        '<div style="text-align: right;" class="' + this.rowBodyDivCls + '">{[Taco.app.context.getCurrent().formatCurrency(parent.discountedTotal)]}</div>',
                    '</td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
            ...
            '<tpl for="shippingDiscounts">',
                '<tr role="row" class="' + this.rowBodyTrCls + ' {rowBodyCls}" tabindex="-1">',
                    ...
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '">',
                        '<div class="' + this.rowBodyDivCls + ' adjustment-cell-inner-wrap">Shipping Discount: {description} - <span class="additional-fee">{[Taco.app.context.getCurrent().formatCurrency(values.total)]}</span></div>',
                    '</td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
            ...
            '<tpl if="handlingAmount">',
                '<tr role="row" class="' + this.rowBodyTrCls + ' {rowBodyCls}" tabindex="-1">',
                    ...
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '">',
                        '<div class="' + this.rowBodyDivCls + ' adjustment-cell-inner-wrap">Handling Fee - <span class="additional-fee">{[Taco.app.context.getCurrent().formatCurrency(values.handlingAmount)]}</span></div>',
                    '</td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
