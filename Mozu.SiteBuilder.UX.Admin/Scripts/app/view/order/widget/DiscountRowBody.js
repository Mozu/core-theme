...
Ext.define('Taco.view.order.widget.DiscountRowBody', {
    ...
    getRowBody: function (values) {
        return [
            ...
            '<div class="' + this.rowBodyDivCls + ' adjustment-cell-inner-wrap">' + Localizer.langResources.ORDERS.Orders.OrderEdit.Shipments.ShippingPackageColumn.discount + ': {description} - <span class="additional-fee">{[Taco.app.context.getCurrent().formatCurrency(values.total)]}</span></div>',
                    '</td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    //'<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell"  class="' + this.rowBodyTdCls + '">',
                ...
                '</tr>',
            '</tpl>',
            '<tpl if="values.discounts.length != 0">',
                '<tr role="row" class="' + this.rowBodyTrCls + ' {rowBodyCls} ',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
            ...
            '<tpl for="shippingDiscounts">',
                '<tr role="row" class="' + this.rowBodyTrCls + ' {rowBodyCls}" tabindex="-1">',
                    ...
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '">',
            '<div class="' + this.rowBodyDivCls + ' adjustment-cell-inner-wrap">' + Localizer.langResources.ORDERS.Orders.OrderEdit.OrderDetails.EditDetailsPopup.shipping_discount + ': {description} - <span class="additional-fee">{[Taco.app.context.getCurrent().formatCurrency(values.total)]}</span></div>',
                    '</td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
            ...
            '<tpl if="handlingAmount">',
                '<tr role="row" class="' + this.rowBodyTrCls + ' {rowBodyCls}" tabindex="-1">',
                    ...
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '">',
            '<div class="' + this.rowBodyDivCls + ' adjustment-cell-inner-wrap">' + Localizer.langResources.ORDERS.Orders.OrderEdit.OrderDetails.EditDetailsPopup.handling_fee + ' - <span class="additional-fee">{[Taco.app.context.getCurrent().formatCurrency(values.handlingAmount)]}</span></div>',
                    '</td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
                    '<td role="gridcell" class="' + this.rowBodyTdCls + '"></td>',
