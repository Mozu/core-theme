...
Ext.define('Taco.store.TooltipHelp', {
    ...
    data: [
        ...
        },
        {
            ...
            value: 'This determines whether the values of this attribute are matched on when shoppers perform a search on the site.'
        },{
            key: 'attribute.form.filterandsorting',
            value: 'This determines whether this attribute is available for filtering, sorting, dynamic category expressions, displayed on category pages, and as a facet in search results.'
        },{
