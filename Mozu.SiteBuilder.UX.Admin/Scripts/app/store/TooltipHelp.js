...
Ext.define('Taco.store.TooltipHelp', {
    ...
    data: [
        ...
        },
        {
            ...
            value: 'This determines whether the value(s) of this attribute for each product it\'s assigned to is matched on when shoppers perform a search on the site. For example, a product is assigned an attribute named Color with a value of "blue”.  If you select this checkbox and Search Value below, and a shopper performs a search for the term “blue” on your site, the product will be returned in the search results even if the term “blue” is not contained in the product\'s name or description.'
        },{
