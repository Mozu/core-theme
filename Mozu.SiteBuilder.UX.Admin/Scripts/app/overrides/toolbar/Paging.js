/**
 * Overridden to explicitly set `msgTarget` to `qtip` on the numberfield.
 */

Ext.define('Taco.overrides.toolbar.Paging', {
    ...
    getPagingItems: function() {
        ...
        me.beforePageText,
        {
            ...
            selectOnFocus: true,
            submitValue: false,
            // other Taco overrides make it necessary to set this explicitly
            msgTarget: 'qtip',
