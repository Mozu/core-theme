...
(function (w) {
    ...
    var firefoxVersion = (function () {
        ...
        process = function (payload) {
            ...
            errors.clear();
            var skipOtherCardTypeValidation = fields.getValue('CardType') === 'OTHER' && fields.getValue('SkipValidationOtherCCType');
            if (!settings.get('skipValidation') && !skipOtherCardTypeValidation) {
                if (!validate()) {
