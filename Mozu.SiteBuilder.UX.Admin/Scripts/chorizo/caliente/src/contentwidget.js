...
(function(win, doc) {
    ...
    class ContentWidget {
        ...
        getUrlTooltip() {
            const urlTooltip = doc.createElement('div');
        ...
        createLink() {
            doc.execCommand('createLink', false, TEMP_LINK_ID);

            this.showUrlTooltip();
        }

        showUrlTooltip() {
            const element = doc.querySelector('[href="' + TEMP_LINK_ID + '"]');
        ...
        getFormatter() {
            ...
            const formatterComponent = doc.createElement('div');
