      ...
      t.subTest('Test the creation of a new customer', function(t) {
        ...
        t.chain(
          ...
          function(next) {
              ...
              t.isHandleHtml(n.form, 'customer-since', '', 'The customer since date should be empty string because this is a new customer, and the date is generated by the server');
